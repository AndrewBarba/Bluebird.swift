...
///
/// - returns: Promise
public func join<A, B>(_ a: Promise<A>, _ b: Promise<B>) -> Promise<(A, B)> {
...
///
/// - returns: Promise
public func join<A, B, C>(_ a: Promise<A>, _ b: Promise<B>, _ c: Promise<C>) -> Promise<(A, B, C)> {
...
///
/// - returns: Promise
public func join<A, B, C, D>(_ a: Promise<A>, _ b: Promise<B>, _ c: Promise<C>, _ d: Promise<D>) -> Promise<(A, B, C, D)> {
